...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        vote_percent = float(cvotes) / float(total_votes) * 100

        # 6d: Print the county results to the terminal.
        county_results_summary = (f"{county_name}: received {vote_percent:.1f}% ({cvotes:,})\n")
        ...
        if (cvotes > winning_count) and (vote_percent > winning_percentage):
